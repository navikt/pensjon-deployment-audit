...
import { PlusIcon, TrashIcon, PencilIcon } from '@navikt/aksel-icons';
  ...
  return (
    <Box padding={{ xs: 'space-16', md: 'space-24' }}>
      <VStack gap="space-24">
        ...
        <BodyShort>
          Kobler GitHub-brukernavn til Nav-identitet og Slack for visning i
          deployment-oversikten.
        </BodyShort>

        {mappings.length === 0 ? (
          <Alert variant="info">
            Ingen brukermappinger er lagt til ennå. Klikk "Legg til" for å
            opprette den første.
          </Alert>
        ) : (
          <Table>
        ...
        <Modal
          ref={addModalRef}
          header={{ heading: 'Legg til brukermapping' }}
            ...
            {editMapping && (
              <Form method="post" id="edit-form">
                ...
                <input
                  type="hidden"
                  name="github_username"
                  value={editMapping.github_username}
                />
                <VStack gap="space-16">
                  <TextField
                    label="GitHub brukernavn"
